...
// Usage:  import { COLORS, FONTS, CIRCLE_STYLES, SHADOWS } from "./theme";
// ─────────────────────────────────────────────────────────────

// ── Custom font family ────────────────────────────────────────
// Font files live in assets/fonts/
// Loaded in _layout.jsx via useFonts() before the app renders.
// NEVER combine fontFamily with fontWeight — use the correct
// font variant directly (Bold file for bold, etc).
export const FONTS = {
