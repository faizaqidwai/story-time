...
function buildGameMap() {
  ...
  const fakeCandidates = Object.values(nodes).filter(
    (n) =>
      n.locId &&
  ...
  const onCorrectPath = fakeCandidates.filter((n) =>
    mainPath.some((m) => m.id === n.locId),
  );
  const onWrongPath = fakeCandidates.filter(
    (n) => !mainPath.some((m) => m.id === n.locId),
  );

  // 2 fake chests on correct path, 1 on wrong branch
  shuffle(onCorrectPath)
    .slice(0, 2)
    .forEach((n) => {
      n.type = "chest_fake";
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Riddle */}
        <View
          style={{ paddingHorizontal: 24, paddingTop: 18, paddingBottom: 10 }}
        >
          <Text
            style={{
              fontSize: 15,
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Chest image */}
        <Animated.View
          style={{ transform: [{ translateY: chestBounce }], marginBottom: 14 }}
        >
          <Image
            source={IMG_CHEST}
        ...
        {showButtons && (
          <View style={{ flexDirection: "row", gap: 12, width: "100%" }}>
            ...
            >
              <Text
                style={{ fontSize: 16, fontWeight: "900", color: C.textSec }}
              >
                🚶 LEAVE
              </Text>
            </TouchableOpacity>
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Opened chest image */}
        <Animated.View
          style={{ transform: [{ scale: chestSc }], marginBottom: 12 }}
        >
          <Image
            source={IMG_OPENED}
        ...
        >
          ...
          <Text style={{ fontSize: 48, fontWeight: "900", color: C.yellow }}>
            {score}
          </Text>
        </View>
        <TouchableOpacity
        ...
        <TouchableOpacity
          ...
          activeOpacity={0.75}
        >
          <Text style={{ fontSize: 14, fontWeight: "700", color: C.textSec }}>
            ✕ Exit Game
          </Text>
        </TouchableOpacity>
      </Animated.View>
...
function LoseOverlay({ reason, sw, sh, onPlayAgain, onExit }) {
  ...
  const configs = {
    deadend_monster: {
      img: IMG_MONSTER,
      title: "A Monster Appeared!",
      msg: "You chose the wrong path and encountered a fearsome monster!",
      color: C.red,
      bg: "rgba(60,0,0,0.98)",
    },
    deadend_ocean: {
      img: IMG_MONSTER,
      title: "Swept Away!",
      msg: "You chose the wrong path and fell into the raging ocean!",
      color: "#1565C0",
      bg: "rgba(0,15,60,0.98)",
    },
    deadend_ditch: {
      img: IMG_PIT,
      title: "Fell into a Pit!",
      msg: "You chose the wrong path and tumbled into a deep dark pit!",
      color: "#5D4037",
      bg: "rgba(20,10,0,0.98)",
    },
    wrong_chest: {
      img: IMG_SNAKE,
      title: "A Snake Bit You!",
      msg: "That was the wrong chest! A snake was hiding inside...",
      color: C.green,
      bg: "rgba(0,30,5,0.98)",
    },
    left_treasure: {
      img: IMG_CHEST,
      title: "You Left the Treasure!",
      msg: "You were so close! The treasure was in that chest you left.",
      color: "#9C27B0",
      bg: "rgba(20,0,40,0.98)",
    },
  };
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Animated.View
          style={{ transform: [{ scale: imgSc }], marginBottom: 14 }}
        >
          <Image
            source={cfg.img}
        ...
        <TouchableOpacity
          ...
          activeOpacity={0.85}
        >
          <Text style={{ fontSize: 16, fontWeight: "900", color: "#1a1a00" }}>
            🗺️ Try Again!
          </Text>
        </TouchableOpacity>
        <TouchableOpacity
  ...
  return (
    ...
    >
      ...
      <View style={{ ...StyleSheet.absoluteFillObject, overflow: "hidden" }}>
        ...
        <View
          style={{
            ...
            right: "10%",
            height: 280,
            backgroundColor: "rgba(255,180,30,0.07)",
            borderRadius: 200,
          }}
        />
        {/* Scattered stars */}
        {Array.from({ length: 30 }, (_, i) => (
          <View
            ...
            style={{
              ...
              borderRadius: 2,
              backgroundColor:
                i % 9 === 0 ? "#FFD54F" : "rgba(255,255,255,0.7)",
              opacity: 0.3 + (i % 5) * 0.1,
            }}
          />
        ))}
      ...
      <TouchableOpacity
        ...
        activeOpacity={0.8}
      >
        <Text style={{ color: C.textSec, fontSize: 15, fontWeight: "700" }}>
          ✕
        </Text>
      </TouchableOpacity>
      ...
      {/* Floating chest */}
      <Animated.View
        style={{ transform: [{ translateY: floatY }], marginBottom: 16 }}
      >
        <Image
          source={IMG_CHEST}
          style={{ width: 120, height: 88, borderRadius: 14 }}
          resizeMode="cover"
        />
      </Animated.View>
      ...
      >
        ...
        >
          ...
          lies a legendary treasure chest — buried in a remote land, guarded by
          treacherous paths and ancient riddles.{"\n\n"}
          You hold a{" "}
          <Text style={{ color: C.yellow, fontWeight: "900" }}>
            Treasure Hunt Map
          </Text>{" "}
          with cryptic clues. Follow them wisely. One wrong turn leads to{" "}
          ...
          {"\n\n"}
          <Text style={{ color: "#69F0AE", fontWeight: "700" }}>
            Only the bravest explorer
          </Text>{" "}
          will find the treasure. Are you ready?
        </Text>
      </Animated.View>
      ...
      >
        A new map is created every time you play
      </Text>
    </View>
  );
}
...
function IntroPopup({ sw, sh, onContinue }) {
  ...
  const tips = [
    ...
    {
      icon: "📖",
      text: "Use your Treasure Map when you need to choose a path — it holds riddle clues",
    },
    {
      icon: "⚠️",
      text: "Wrong paths lead to monsters, ocean falls or deadly pits",
    },
    {
      icon: "📦",
      text: "You may find chests along the way — always check the guide before opening one",
    },
    {
      icon: "🐍",
      text: "Remote places hide dangerous snakes inside false chests!",
    },
  ];
      ...
      >
        ...
        <View
          style={{
            ...
            borderBottomColor: "rgba(255,213,79,0.25)",
          }}
        >
...
export default function TreasureHuntGame({ onExit }) {
  ...
  const handleSceneTap = useCallback(() => {
    ...
    if (node.type === "choice") {
      ...
      Animated.parallel([
        Animated.spring(leftBoxAnim, {
          toValue: 1,
          friction: 5,
          tension: 60,
          useNativeDriver: true,
        }),
        Animated.spring(rightBoxAnim, {
          toValue: 1,
          friction: 5,
          tension: 60,
          useNativeDriver: false,
  ...
  const handleChoiceTap = useCallback(
    (side) => {
      ...
      const chosenNodeId =
        side === "left" ? currentNode.left : currentNode.right;
  ...
  // ── Welcome screen ────────────────────────────────────────
  if (phase === "welcome") {
    return <WelcomeScreen onStart={startGame} onExit={handleExit} />;
  }
  ...
  if (!gameMap || !currentNode) {
    return (
      ...
      >
        ...
        <Text style={{ color: C.textSec, fontSize: 16, marginTop: 12 }}>
  ...
  const node = currentNode;
  const leftLoc = node.leftLocId
    ? LOCATION_DATA.find((l) => l.id === node.leftLocId)
    : null;
  const rightLoc = node.rightLocId
    ? LOCATION_DATA.find((l) => l.id === node.rightLocId)
    : null;
  ...
  return (
    <View style={{ flex: 1, backgroundColor: C.bg, overflow: "hidden" }}>
                    ...
                    <Animated.View
                      style={{
                        ...
                        borderColor:
                          wrongFlash === "left"
                            ? C.red
                            : lastChoice === "correct" && chosenSide === "left"
                              ? C.green
                              : "rgba(255,213,79,0.5)",
                    ...
                    <Animated.View
                      style={{
                        ...
                        borderColor:
                          wrongFlash === "right"
                            ? C.red
                            : lastChoice === "correct" && chosenSide === "right"
                              ? C.green
                              : "rgba(255,213,79,0.5)",
                        ...
                        transform: [
                          {
                            scale: rightBoxAnim.interpolate({
                              inputRange: [0, 1],
                              outputRange: [0.85, 1],
                            }),
                          },
      ...
      {phase === "intro" && (
        <IntroPopup sw={sw} sh={sh} onContinue={() => setPhase("walking")} />
      )}
      ...
      {isChoice && guideOpen && node.riddleText && (
        ...
        >
          <View style={{ marginTop: 12, gap: 10 }}>
            ...
            >
              <Text
                style={{ color: C.yellow, fontWeight: "800", fontSize: 14 }}
              >
