...
const Progress = () => {
  ...
  const stats = {
    ...
    currentLevel: currentProfile?.readingLevel || "Early",
  };
  ...
  const achievements = [
    {
      ...
      title: "First Story",
      icon: "📖",
      earned: userBadges.includes("first_story"),
    },
    {
      id: "week_warrior",
      title: "Week Warrior",
      icon: "🔥",
      earned: userBadges.includes("week_warrior"),
    },
    {
      id: "category_explorer",
      title: "Category Explorer",
      icon: "🌟",
      earned: userBadges.includes("category_explorer"),
    },
    {
      id: "speed_reader",
      title: "Speed Reader",
      icon: "⚡",
      earned: userBadges.includes("speed_reader"),
    },
    {
      id: "night_owl",
      title: "Night Owl",
      icon: "🦉",
      earned: userBadges.includes("night_owl"),
    },
    {
      id: "early_bird",
      title: "Early Bird",
      icon: "🐦",
      earned: userBadges.includes("early_bird"),
    },
  ];
  ...
  const recentStories =
    readingHistory.length > 0
      ? readingHistory
          ...
          .reverse()
          .map((story, index) => ({
            id: `${story.storyId}-${story.completedAt}-${index}`,
  ...
  const LEVEL_CONFIG = {
    beginner: {
      percent: 10,
      label: "Early Reader",
      message: "10% to Advance level!",
    },
    intermediate: {
      percent: 50,
      label: "Middle",
      message: "50% to Advance level!",
    },
    expert: {
      percent: 100,
      label: "Advance Reader",
      message: "You reached Advance level! 🎉",
    },
  };
  const level = currentProfile?.readingLevel || "beginner";
      ...
      <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.levelCard}>
            <Text style={styles.currentLevel}>{levelData.label}</Text>
            <View style={styles.levelProgress}>
              ...
              <Text style={styles.levelText}>{levelData.message}</Text>
            </View>
          </View>
        </View>
