/**
 * DiamondInfoModal.jsx
 * app/components/DiamondInfoModal.jsx
 *
 * Opened when user taps the diamond icon in home.jsx header.
 * Uses the exact same animation pattern as StoryFinishOverlay:
 *   - Bottom sheet slides up
 *   - Steps pop in (scale 0.85→1 + opacity) and hold
 *   - Steps 0,1 auto-advance after 1200ms
 *   - Last step shows Continue button
 *
 * Step 0: Big diamond pile — "X Diamonds" — "you have!"
 * Step 1: What diamonds do — unlock games
 * Step 2: How to earn — complete stories
 */
...
// Info chip used in steps 1 and 2
function InfoChip({ icon, text, delay, enterAnim }) {
...
const cS = StyleSheet.create({
  chip: {
    ...
    backgroundColor: "rgba(0,188,212,0.1)", borderWidth: 1.5,
...
const STEPS = (diamonds) => [
  ...
  },
  {
    ...
    image:       require("../../assets/img/diamond.png"),
    heading:     "What Diamonds Do",
    countLabel:  "9 💎",
    countUnit:   "to unlock a game",
    subLabel:    "spend diamonds to reveal hidden games",
    chips: [
      { icon: "🎮", text: "Unlock hidden games inside each level" },
      { icon: "🔒", text: "Diamonds never expire — save them up!" },
    ],
    showContinue: false,
  },
  {
    ...
    countLabel:  "+3 💎",
    countUnit:   "per story",
    subLabel:    "complete any story to earn diamonds",
    chips: [
      { icon: "📚", text: "Complete any story to earn 3 diamonds" },
      { icon: "✨", text: "Read more stories, unlock more games!" },
    ],
    showContinue: true,
  },
];
