...
const COLORS = {
  ...
  yellowBorder: "rgba(245,166,35,0.6)",
  pink: "#E8445A",
  textPrimary: "#FFFFFF",
  textSecondary: "#8899AA",
  textMuted: "#8899AA",
  borderTeal: "rgba(0,196,204,0.3)",
  borderTealBold: "rgba(0,196,204,0.6)",
  correct: "#2A9D8F",
  wrong: "#E8445A",
};
...
const cardS = StyleSheet.create({
  ...
  letterText: {
    ...
    color: "#F5A623",
    textShadowColor: "rgba(245,166,35,1)",
...
const styles = StyleSheet.create({
  ...
  challengeTitle: {
    ...
    color: COLORS.teal,
    letterSpacing: 0.4,
    textShadowColor: "rgba(0,196,204,0.75)",
    textShadowOffset: { width: 0, height: 0 },
    textShadowRadius: 18,
    textAlign: "center",
  },
  ...
  cloudText: {
    ...
    textShadowColor: "rgba(245,166,35,0.9)",
    textShadowOffset: { width: 0, height: 0 },
    textShadowRadius: 10,
  },
  ...
  cloudTailTriangle: {
    ...
    borderTopColor: "rgba(245,166,35,0.75)",
  },
  ...
  speakerBtnActive: {
    backgroundColor: "rgba(0,196,204,0.18)",
    borderColor: "rgba(0,196,204,0.5)",
  },
  ...
  flowerCard: {
    position: "absolute",
    bottom: 0,
    borderColor: "rgba(123,47,190,0.26)",
    marginBottom: pad.s,
  ...
  heartOn: {
    color: "#E8445A",
    textShadowColor: "rgba(232,68,90,0.8)",
    textShadowOffset: { width: 0, height: 0 },
    textShadowRadius: 6,
  },
  ...
  keyWrong: {
    ...
    borderColor: "rgba(232,68,90,0.26)",
  },
  keyTextWrong: { color: "rgba(232,68,90,0.35)" },
