...
export default function OnboardingScreen() {
  ...
  const stepIndex = [STEP.NAME, STEP.AGE, STEP.GENDER, STEP.LEVEL].indexOf(
    step,
  );
        ...
        >
          <View style={[styles.container, { marginTop: 0 }]}>
            ...
            <View
              style={[
                styles.progressRow,
                { marginBottom: sz.progressMarginBottom, width: cardWidth },
              ]}
            >
              {[0, 1, 2, 3].map((i) => (
                <View
            ...
            <Text
              style={[
                styles.stepHint,
                { fontSize: font.md, marginBottom: sz.stepHintMarginBottom },
              ]}
            >
              {meta.hint}
            </Text>
