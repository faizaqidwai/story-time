...
function MiniCat() {
  ...
  return (
    <View style={{ alignItems: "center", justifyContent: "center", width: sz, height: sz, alignSelf: "center", marginTop: 14, marginBottom: 6 }}>
      ...
      <View style={{ position: "absolute", bottom: 0, left: 8, width: 52, height: 38, backgroundColor: "#F4A460", borderRadius: 14, borderWidth: 2, borderColor: "#CD853F", alignItems: "center", justifyContent: "center", paddingBottom: 4 }}>
...
function MiniMonkey() {
  ...
  return (
    <View style={{ alignItems: "center", justifyContent: "center", marginTop: 14, marginBottom: 6, height: containerH }}>
      <View style={{ width: bodySize, height: bodySize, borderRadius: bodySize / 2, backgroundColor: "#8B5E3C", borderWidth: 2.5, borderColor: "#5C3A1E", alignItems: "center", justifyContent: "center", shadowColor: "#8B5E3C", shadowOffset: { width: 0, height: 0 }, shadowOpacity: 0.8, shadowRadius: 10, elevation: 8 }}>
        <View style={{ width: bodySize * 0.6, height: bodySize * 0.55, borderRadius: bodySize * 0.3, backgroundColor: "#D4956A", borderWidth: 1, borderColor: "#B07040" }} />
        ...
        <View style={{ position: "absolute", bottom: bodySize * 0.18, width: 12, height: 6, borderBottomLeftRadius: 8, borderBottomRightRadius: 8, borderWidth: 1.5, borderColor: "#5C3A1E", borderTopWidth: 0 }} />
      ...
      <Animated.View style={{ position: "absolute", top: 4, right: isTablet ? 14 : 8, width: isTablet ? 44 : 32, height: 3, backgroundColor: "#5C3A1E", borderRadius: 2, transform: [{ rotate: rodRot }] }} />
      <Animated.Text style={{ position: "absolute", bottom: isTablet ? 6 : 2, right: isTablet ? 4 : 0, fontSize: isTablet ? 20 : 14, transform: [{ translateY: fishY }] }}>🐟</Animated.Text>
    </View>
  );
}
